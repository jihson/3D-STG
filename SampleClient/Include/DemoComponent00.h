...
class DemoComponent00 : public Component
{
private:
	//explicit TestComponent2(class GameObject* owner);
	DemoComponent00(GameObject * owner)
		: Component(BehaviourType::Update | BehaviourType::LateUpdate, owner)
	{

	}

	virtual ~DemoComponent00() {}


public:
	static DemoComponent00 * Create(GameObject * owner)
	{
		DemoComponent00 * com = new DemoComponent00(owner);
		com->Initialize();
		return com;
